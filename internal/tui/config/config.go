		...
		},
		{
			...
			Items: []ConfigItem{
				...
				},
				{
					...
					Description: "Add --dangerously-skip-permissions when starting Claude (deprecated: use Permission Mode)",
					Type:        "bool",
					Category:    "ai",
				},
				{
					Key:         "ai.claude.permission_mode",
					Label:       "Claude Permission Mode",
					Description: "How Claude handles permission prompts (overrides Skip Permissions when set)",
					Type:        "select",
					Options:     append([]string{""}, config.ValidClaudePermissionModes()...),
					Category:    "ai",
				},
				{
					Key:         "ai.claude.allowed_tools",
					Label:       "Claude Allowed Tools",
					Description: "Tools Claude may use without prompting (comma-separated, e.g. Read,Write,Bash)",
					Type:        "string",
					Category:    "ai",
				},
				{
					Key:         "ai.claude.disallowed_tools",
					Label:       "Claude Disallowed Tools",
					Description: "Tools explicitly denied to Claude (comma-separated)",
					Type:        "string",
					Category:    "ai",
				},
				{
					Key:         "ai.claude.max_turns",
					Label:       "Claude Max Turns",
					Description: "Maximum agentic turns per session (0 = unlimited)",
					Type:        "int",
					Category:    "ai",
				},
				{
					Key:         "ai.claude.model",
					Label:       "Claude Model",
					Description: "Model alias (sonnet, opus, haiku) or full model ID",
					Type:        "string",
					Category:    "ai",
				},
				{
					Key:         "ai.claude.append_system_prompt",
					Label:       "Claude Append System Prompt",
					Description: "Additional text appended to Claude's default system prompt",
					Type:        "string",
					Category:    "ai",
				},
				{
		...
		},
		{
			...
			Items: []ConfigItem{
				...
				},
				{
					...
					Type:        "select",
					Options:     append([]string{""}, config.ValidAIBackends()...),
					Category:    "adversarial",
				},
			},
		},
...
func (m *Model) resetCurrentToDefault() {
	...
	defaultValues := map[string]any{
		...
		"ai.claude.permission_mode":      defaults.AI.Claude.PermissionMode,
		"ai.claude.allowed_tools":        strings.Join(defaults.AI.Claude.AllowedTools, ","),
		"ai.claude.disallowed_tools":     strings.Join(defaults.AI.Claude.DisallowedTools, ","),
