...
var rootCmd = &cobra.Command{
	...
	Long: `Claudio enables running multiple Claude Code instances simultaneously on a
single project using git worktrees, with a central orchestrator managing
